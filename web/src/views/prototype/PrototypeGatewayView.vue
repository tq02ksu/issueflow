    ...
    <div class="prototype-page">
      ...
      <div class="gateway-grid">
        ...
        <n-card :bordered="false" class="gw-card">
          ...
          <div class="gw-card__body">
            <div class="gw-metric">
              <span class="gw-metric__label">{{
                t("prototype.gateway.currentRunBudget")
              }}</span>
              <span class="gw-metric__value">$0.24</span>
            </div>
            <div class="gw-metric">
              <span class="gw-metric__label">{{
                t("prototype.gateway.loopDailyBudget")
              }}</span>
              <span class="gw-metric__value">$5.00</span>
            </div>
            <div class="gw-metric">
              <span class="gw-metric__label">{{
                t("prototype.gateway.monthlyBudget")
              }}</span>
          ...
          <div class="gw-card__body">
            <article class="gw-item" v-for="p in providers" :key="p.id">
              <div class="gw-item__header">
                ...
                <span
                  class="gw-item__status"
                  :class="`gw-item__status--${p.status}`"
                  >{{ p.status }}</span
                >
              </div>
...
const modelTiers = [
  {
    ...
    label: "cheap-fast",
    model: "GPT-4o-mini",
    useCase: "Health checks, status queries, simple evaluations",
  },
  {
    key: "balanced",
    label: "balanced",
    model: "GPT-4o",
    useCase: "Issue analysis, MR review, recommendation generation",
  },
  {
    key: "high-reasoning",
    label: "high-reasoning",
    model: "Claude 3.5 Sonnet",
    useCase: "Complex verification, governance analysis",
  },
];
