...
export const prototypeLoops: PrototypeLoop[] = [
  {
    ...
    stateMachinePolicy: "Issue lifecycle: new → clarifying → planned → ready_for_execution → in_execution → done",
    skillRefs: ["delivery-skill"],
    verificationPolicy: "Check acceptance criteria completeness before state transition.",
  ...
  },
  {
    ...
    stateMachinePolicy: "MR lifecycle: draft → in_review → changes_requested → ready_to_merge → merged",
    skillRefs: ["delivery-skill"],
    verificationPolicy: "Confirm review comments are resolved before merge recommendation.",
    budgetPolicy: "Max 3000 tokens per run",
    notificationPolicy: "Notify on changes_requested → ready_to_merge transitions",
    nextRunAt: null,
  ...
  },
  {
    ...
    stateMachinePolicy: "Pressure-based: flag risk when >30% issues still in clarifying phase",
    skillRefs: ["delivery-skill"],
    verificationPolicy: "Cross-check milestone scope completeness before risk flagging.",
  ...
  },
  {
    ...
    stateMachinePolicy: "Quality gate: flag if acceptance < 80% precision score",
    skillRefs: ["delivery-skill"],
...
export const prototypeApprovals: PrototypeApproval[] = [
  {
    ...
    memoryRelation: "Issue state transition from clarifying to ready_for_execution.",
    status: "pending",
  ...
  },
  {
    ...
    targetUrl: "/workbench/issues",
    draftContent:
      "Review-state vocabulary agreed. Moving issue to planned.",
  ...
  },
  {
    ...
    memoryRelation: "Recurring pattern: broad acceptance language leads to rework.",
    status: "rejected",
...
export const prototypeTurns: PrototypeTurn[] = [
  {
    ...
    durationSecs: 270,
    summary: "Scanned issue-101 and mr-88. Issue ready for execution, MR needs naming alignment.",
    conclusion: "Issue-101 can advance to ready_for_execution. MR-88 requires review comment resolution before merge.",
    events: [
      { timestamp: "2026-07-04T10:10:00Z", kind: "created", message: "Turn triggered by schedule." },
      { timestamp: "2026-07-04T10:10:05Z", kind: "fetching_objects", message: "Fetched 2 objects (1 issue, 1 MR)." },
      { timestamp: "2026-07-04T10:12:00Z", kind: "memory_loaded", message: "Loop memory loaded: previous state context restored." },
      { timestamp: "2026-07-04T10:13:00Z", kind: "executor_invoked", message: "Executor evaluated issue-101 acceptance criteria.", targetId: "issue-101", agentId: "loop-executor-v2" },
      { timestamp: "2026-07-04T10:13:30Z", kind: "executor_invoked", message: "Executor scanned MR-88 review comments.", targetId: "mr-88", agentId: "mr-progression-core" },
      { timestamp: "2026-07-04T10:14:00Z", kind: "evaluator_confirmed", message: "Evaluator confirmed issue-101 readiness and MR-88 naming concern." },
      { timestamp: "2026-07-04T10:14:20Z", kind: "conclusion_generated", message: "Conclusion drafted for both objects." },
      { timestamp: "2026-07-04T10:14:30Z", kind: "approval_requested", message: "Approval requested for 2 draft actions." },
    ],
    agents: [
      { agentId: "loop-executor-v2", agentName: "Loop Executor v2", role: "executor", model: "balanced", status: "done", tokensUsed: 2100, cost: 0.021, retries: 0, responsibleFor: ["issue-101"] },
      { agentId: "mr-progression-core", agentName: "MR Progression Core", role: "executor", model: "balanced", status: "done", tokensUsed: 1320, cost: 0.013, retries: 0, responsibleFor: ["mr-88"] },
      { agentId: "evaluator-core", agentName: "Evaluator Core", role: "evaluator", model: "cheap-fast", status: "done", tokensUsed: 450, cost: 0.0002, retries: 0, responsibleFor: ["issue-101", "mr-88"] },
    ],
    draftActions: [
      { targetId: "issue-101", actionType: "issue_comment", draftContent: "Issue is ready_for_execution. All acceptance criteria are clear.", riskLevel: "low" },
      { targetId: "mr-88", actionType: "mr_comment", draftContent: "Two naming comments remain on workflow badge rendering.", riskLevel: "medium" },
    ],
    recommendations: ["Start dev handoff for issue-101", "Resolve naming comments on MR-88"],
  ...
  },
  {
    ...
    durationSecs: 210,
    summary: "Milestone Beta launch health check. One issue still clarifying, flagged as at-risk.",
    conclusion: "Beta launch milestone has delivery risk. Issue-102 in clarifying state delays downstream MRs.",
    events: [
      { timestamp: "2026-07-03T08:55:00Z", kind: "created", message: "Turn triggered by daily schedule." },
      { timestamp: "2026-07-03T08:55:02Z", kind: "fetching_objects", message: "Fetched milestone and linked items." },
      { timestamp: "2026-07-03T08:56:00Z", kind: "memory_loaded", message: "Loop memory loaded: issue-102 clarifying state persisted." },
      { timestamp: "2026-07-03T08:57:00Z", kind: "executor_invoked", message: "Executor aggregated workflow states.", targetId: "ms-q3", agentId: "milestone-health-core" },
      { timestamp: "2026-07-03T08:57:30Z", kind: "evaluator_confirmed", message: "Evaluator confirmed at-risk flag." },
      { timestamp: "2026-07-03T08:58:00Z", kind: "conclusion_generated", message: "Conclusion: flag as at-risk, recommend pushing issue-102." },
      { timestamp: "2026-07-03T08:58:30Z", kind: "completed", message: "Turn completed. Milestone flagged with risk." },
    ],
    agents: [
      { agentId: "milestone-health-core", agentName: "Milestone Health Core", role: "executor", model: "cheap-fast", status: "done", tokensUsed: 580, cost: 0.0003, retries: 0, responsibleFor: ["ms-q3"] },
      { agentId: "evaluator-core", agentName: "Evaluator Core", role: "evaluator", model: "cheap-fast", status: "done", tokensUsed: 400, cost: 0.0002, retries: 0, responsibleFor: ["ms-q3"] },
    ],
    draftActions: [],
    recommendations: ["Push issue-102 to planned", "Re-evaluate milestone in 2 days"],
  ...
  },
  {
    ...
    durationSecs: 180,
    summary: "Manual evaluation triggered for issue-102. Vocabulary consensus confirmed.",
    conclusion: "Review-state vocabulary now agreed. Issue-102 can move to planned.",
    events: [
      { timestamp: "2026-07-02T13:50:00Z", kind: "created", message: "Turn triggered manually." },
      { timestamp: "2026-07-02T13:50:02Z", kind: "fetching_objects", message: "Issue data and discussion fetched." },
      { timestamp: "2026-07-02T13:52:00Z", kind: "executor_invoked", message: "Executor evaluated vocabulary alignment.", targetId: "issue-102", agentId: "loop-executor-v2" },
      { timestamp: "2026-07-02T13:52:30Z", kind: "evaluator_confirmed", message: "Evaluator confirmed vocabulary consensus." },
      { timestamp: "2026-07-02T13:53:00Z", kind: "completed", message: "Turn completed. State advanced to planned." },
    ],
    agents: [
      { agentId: "loop-executor-v2", agentName: "Loop Executor v2", role: "executor", model: "high-reasoning", status: "done", tokensUsed: 4800, cost: 0.072, retries: 0, responsibleFor: ["issue-102"] },
      { agentId: "evaluator-core", agentName: "Evaluator Core", role: "evaluator", model: "balanced", status: "done", tokensUsed: 880, cost: 0.0088, retries: 0, responsibleFor: ["issue-102"] },
    ],
    draftActions: [{ targetId: "issue-102", actionType: "issue_comment", draftContent: "Review-state vocabulary agreed. Moving to planned.", riskLevel: "low" }],
    recommendations: ["Proceed to planning for issue-102"],
    memoryRead: ["loop:issue-102"],
    memoryWritten: "issue-102 vocabulary consensus reached; state transitioned to planned",
    totalTokens: 5680,
    totalCost: 0.0808,
  },
  {
    ...
    durationSecs: 180,
    summary: "Scheduled turn failed. Memory layer returned stale data after retry exhaustion.",
    conclusion: "Turn failed due to memory desync. Requires manual intervention or memory rebuild.",
    events: [
      { timestamp: "2026-07-02T10:10:00Z", kind: "created", message: "Turn triggered by schedule." },
      { timestamp: "2026-07-02T10:10:03Z", kind: "fetching_objects", message: "Issue data fetched." },
      { timestamp: "2026-07-02T10:12:00Z", kind: "executor_invoked", message: "Executor attempted evaluation with stale memory.", targetId: "issue-101", agentId: "loop-executor-v2" },
      { timestamp: "2026-07-02T10:13:00Z", kind: "failed", message: "Turn failed: memory desync detected after 2 retries." },
    ],
    agents: [
      { agentId: "loop-executor-v2", agentName: "Loop Executor v2", role: "executor", model: "balanced", status: "failed", tokensUsed: 1200, cost: 0.012, retries: 2, responsibleFor: ["issue-101"] },
    ],
    draftActions: [],
  ...
  },
  {
    ...
    targets: [
      {
        objectType: "milestone",
        objectId: "ms-lab",
        actions: ["Evaluate acceptance language precision", "Cross-check asset quality"],
    ...
    durationSecs: 300,
    summary: "Acceptance quality evaluation. Both milestone and MR flagged for language precision issues.",
    conclusion: "Acceptance language remains too broad across both objects. Governance risk flagged.",
    events: [
      { timestamp: "2026-07-02T08:20:00Z", kind: "created", message: "Turn triggered by schedule." },
      { timestamp: "2026-07-02T08:20:02Z", kind: "fetching_objects", message: "Fetched milestone, MR, and linked items." },
      { timestamp: "2026-07-02T08:23:00Z", kind: "memory_loaded", message: "Loop memory loaded: recurring acceptance quality concerns." },
      { timestamp: "2026-07-02T08:24:00Z", kind: "executor_invoked", message: "Executor evaluated acceptance language precision.", targetId: "ms-lab", agentId: "quality-gate-core" },
      { timestamp: "2026-07-02T08:24:20Z", kind: "executor_invoked", message: "Executor scanned MR copy quality.", targetId: "mr-201", agentId: "mr-progression-core" },
      { timestamp: "2026-07-02T08:24:40Z", kind: "evaluator_confirmed", message: "Evaluator: acceptance language remains too broad across both objects." },
      { timestamp: "2026-07-02T08:25:00Z", kind: "completed", message: "Turn completed. Objects flagged for governance review." },
    ],
    agents: [
      { agentId: "quality-gate-core", agentName: "Quality Gate Core", role: "executor", model: "high-reasoning", status: "done", tokensUsed: 5200, cost: 0.078, retries: 0, responsibleFor: ["ms-lab"] },
      { agentId: "mr-progression-core", agentName: "MR Progression Core", role: "executor", model: "balanced", status: "done", tokensUsed: 1600, cost: 0.016, retries: 0, responsibleFor: ["mr-201"] },
      { agentId: "evaluator-core", agentName: "Evaluator Core", role: "evaluator", model: "high-reasoning", status: "done", tokensUsed: 1430, cost: 0.021, retries: 0, responsibleFor: ["ms-lab", "mr-201"] },
    ],
    draftActions: [
      { targetId: "ms-lab", actionType: "milestone_update", draftContent: "Acceptance language too broad. Recommend reject until tightened.", riskLevel: "critical" },
      { targetId: "mr-201", actionType: "mr_comment", draftContent: "Copy still ambiguous per reviewer feedback. Tighten before re-review.", riskLevel: "medium" },
    ],
    recommendations: ["Tighten acceptance criteria templates", "Review all object copy for precision"],
    memoryRead: ["loop:ms-lab", "loop:mr-201", "governance:governance"],
    memoryWritten: "acceptance quality concern detected across ms-lab and mr-201",
    totalTokens: 8230,
    totalCost: 0.115,
  },
  {
    ...
    durationSecs: 180,
    summary: "Quality gate turn for MR comment posting. Execution failed during comment submission.",
    conclusion: "Comment submission failed with 403. Likely permission issue — requires manual investigation.",
    events: [
      { timestamp: "2026-07-01T15:55:00Z", kind: "created", message: "Turn triggered by MR update event." },
      { timestamp: "2026-07-01T15:55:02Z", kind: "fetching_objects", message: "MR data and review state fetched." },
      { timestamp: "2026-07-01T15:57:00Z", kind: "executor_invoked", message: "Executor generated comment draft.", targetId: "mr-201", agentId: "mr-progression-core" },
      { timestamp: "2026-07-01T15:57:40Z", kind: "evaluator_confirmed", message: "Evaluator approved draft content." },
      { timestamp: "2026-07-01T15:58:00Z", kind: "failed", message: "Turn failed: comment submission returned 403." },
    ],
    agents: [
      { agentId: "mr-progression-core", agentName: "MR Progression Core", role: "executor", model: "balanced", status: "failed", tokensUsed: 1600, cost: 0.016, retries: 1, responsibleFor: ["mr-201"] },
    ],
    draftActions: [{ targetId: "mr-201", actionType: "mr_comment", draftContent: "Copy tightened per reviewer feedback. Ready for re-review.", riskLevel: "medium" }],
...
export const prototypeMemoryItems: PrototypeMemoryItem[] = [
  {
    ...
    objectType: "issue",
    objectId: "issue-101",
    summary: "Issue is ready for execution. Acceptance criteria and verification plan are defined. UI profile ordering dependency still unresolved.",
    ...
    suggestedNextSteps: ["Start dev handoff", "Resolve UI profile ordering first"],
  ...
  },
  {
    ...
    objectType: "issue",
    objectId: "issue-102",
    summary: "Issue vocabulary is still in clarifying phase. Review-state naming not yet agreed across team.",
    knownRisks: ["State model may drift from backend terminology."],
    knownBlockers: ["Review-state vocabulary not agreed."],
    suggestedNextSteps: ["Clarify review state model", "Align with backend terminology"],
  ...
  },
  {
    ...
    objectType: "project",
    objectId: "alpha",
    summary: "Alpha Delivery project is stable. Workflow state model is in active refinement. Review-state naming is the current open concern.",
  ...
  },
  {
    ...
    objectType: "project",
    objectId: "beta",
    summary: "AA Workflow Lab project has acceptance quality concerns. Language precision needs improvement before rollout.",
    knownRisks: ["Acceptance language too abstract for long-session use."],
    knownBlockers: ["Acceptance checklist not finalized."],
    suggestedNextSteps: ["Tighten acceptance criteria", "Test copy readability on smaller screens"],
  ...
  },
  {
    ...
    objectType: "system",
    objectId: "governance",
    summary: "Governance engine detected one high-risk recurring pattern: broad acceptance language leading to rework across workbenches.",
    knownRisks: ["Recurring acceptance quality issues", "One execution failure in past week"],
    knownBlockers: [],
    suggestedNextSteps: ["Review acceptance templates", "Consider tightening auto-evaluation thresholds"],
    lastUpdatedAt: "2026-07-04T10:14:30Z",
